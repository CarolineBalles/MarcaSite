				...
				<div class="col-sm-12 col-md-6 create">
					...
					<form action="{{route('proposal.update', ['proposal' => $proposal->id])}}" method="post">
						<div class="form-group">
							...
							<input class="form-control @error('address') is-invalid @enderror" type="text" name="address" id="address" value="{{$proposal->address}}">
							@error('address')
    							<div class="invalid-feedback">
    								{{ $message }}
    							</div>
							...
							<input class="form-control @error('service') is-invalid @enderror" type="text" name="service" id="service" value="{{$proposal->service}}">
							@error('service')
    							<div class="invalid-feedback">
    								{{ $message }}
    							</div>
							...
							<input class="form-control @error('amount') is-invalid @enderror" type="text" name="amount" id="amount" value="{{$proposal->amount}}">
							@error('amount')
    							<div class="invalid-feedback">
    								{{ $message }}
    							</div>
							...
							<input class="form-control @error('entrance') is-invalid @enderror" type="text" name="entrance" id="entrance" value="{{$proposal->entrance}}">
							@error('entrance')
    							<div class="invalid-feedback">
    								{{ $message }}
    							</div>
							...
							<input class="form-control @error('number_installments') is-invalid @enderror" type="text" name="number_installments" id="number_installments" value="{{$proposal->number_installments}}">
							...
							<input class="form-control @error('installments_value') is-invalid @enderror" type="text" name="installments_value" id="installments_value" value="{{$proposal->installments_value}}">
					...
					<a class="btn btn-primary" href="{{route('proposal.index')}}">Voltar a Lista</a>
				</div>
			</div>
		</div>

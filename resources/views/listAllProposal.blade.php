		...
		<div class="container">
			<div class="row list">
				<div class="col-sm-12">
					<div class="row">
						<div class="col">
							<h2 class="inline col">LISTA DE PROPOSTAS</h2>
					...
					<div class="row">
						<div class="col-sm-12">
							<table class="table table-bordered table-hover ">
								...
								@foreach($proposals as $proposal)
									...
									<tr>
										...
										<td>{{date('d/m/Y', strtotime($proposal->pay_day))}}</td>
							...
							<a href="{{route('proposal.export')}}" class="btn btn-primary" href="">Exportar</a>
							<hr>
						</div>
					</div>
				</div>
